...
export class LoginComponent implements OnInit {
  ...
  private odooService : OdooRPCService;
  private router : Router;

  constructor(fb: FormBuilder, alertService: AlertService, userService: UserService, odooService: OdooRPCService) {
      ...
      this.odooService = new OdooRPCService(new Cookipes);
  }
